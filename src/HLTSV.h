...
public:
    ...
    /**
     * Time to complete building an event
     */
    uint64_t                      RoIB_time_Build;

    /**
     * Time to complete processing an event
     */
    uint64_t                      RoIB_time_Process;

    /**
     * Time elapsed for timeouts
     */
	...
	out << "RoIB_time_Build: " << RoIB_time_Build << "\t// Time to complete building an event" << std::endl;
	out << "RoIB_time_Process: " << RoIB_time_Process << "\t// Time to complete processing an event" << std::endl;
	out << "RoIB_timeout: " << RoIB_timeout << "\t// Time elapsed for timeouts" << std::endl;
...
protected:
	...
	out << Rate << Recent_LVL1_ID << Recent_Global_ID << Busy << LVL1DecodingErrors << RoIB_Pending_RNP;
	out << RoIB_Pending_DAQ << RoIB_time_Build << RoIB_time_Process << RoIB_timeout << RNP_Free_pages;
	...
	in >> Rate >> Recent_LVL1_ID >> Recent_Global_ID >> Busy >> LVL1DecodingErrors >> RoIB_Pending_RNP;
	in >> RoIB_Pending_DAQ >> RoIB_time_Build >> RoIB_time_Process >> RoIB_timeout >> RNP_Free_pages;
